...
run_test() {
    ...
    # Write input to file using printf to avoid shell expansion issues
    printf "%s\n" "$input" > "$tmpfile"
...
run_test '( cd /tmp )'	"ZC1088" 'ZC1044: Subshell cd unchecked (Caught by ZC1088)'
...
run_test 'echo {1..$n}'	"" 'ZC1083: unquoted variable range end is valid in Zsh'
run_test 'echo {$n..10}'	"" 'ZC1083: unquoted variable range start is valid in Zsh'
...
run_test 'find . -name [a-z]'	"ZC1054" 'ZC1084: [a-z] (Expected ZC1054)'
run_test 'find . -name "[a-z]"'	"ZC1054" 'ZC1084: "[a-z]" (Expected ZC1054)'
run_test 'find . -name \*.txt'	"" 'ZC1084: \*.txt (Valid)'
...
run_test 'function foo() { :; }'	"ZC1086" 'ZC1086: function foo()'
run_test 'function foo { :; }'	"ZC1086" 'ZC1086: function foo'
run_test 'foo() { :; }'	"" 'ZC1086: foo() (Valid)'

# --- ZC1087: Redirection clobbering ---
run_test 'sort file.txt > file.txt'	"ZC1087" 'ZC1087: simple clobbering'
run_test 'cat file.txt | grep foo > file.txt'	"ZC1087" 'ZC1087: pipeline clobbering'
...
run_test '( var=1; : )'	"" 'ZC1088: ( var=1; : ) (Valid)'

# --- ZC1089: Redirection order ---
